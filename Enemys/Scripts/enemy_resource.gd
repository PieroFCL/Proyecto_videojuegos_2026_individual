...
@export var weakness: String = "physical"   # "physical" o "magical"
@export var is_boss: bool = false

# Textura para el mundo (movimiento, idle)
...
# Habilidades que puede usar este enemigo en combate (2-4 recomendado)
